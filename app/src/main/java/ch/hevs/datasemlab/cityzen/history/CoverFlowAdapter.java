...
public class CoverFlowAdapter extends BaseAdapter {
    ...
    public CoverFlowAdapter(Context context, ArrayList<CulturalItem> objects) {
        this.activity = context;
        this.data = objects;
    }
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        byte[] imageAsByteArray = data.get(position).getImage();
...
//                mPosition = position;
//
////                new ImageViewLoader().execute(String.valueOf(position));
//
...
//    }
    ...
    public void updateEntries(ArrayList<CulturalItem> historicalCulturalItems){
        data.addAll(historicalCulturalItems);
//        data = historicalCulturalItems;

        Log.i(TAG, "Update Entries: " +data.size());
