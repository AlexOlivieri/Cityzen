...
//        notificationManager.notify(001, notification);
    ...
    public int onStartCommand (Intent intent, int flags, int startId) {
        if(intent !=null) {
            ...
            String latitude = intent.getStringExtra(CityzenContracts.LATITUDE);
            String longitude = intent.getStringExtra(CityzenContracts.LONGITUDE);
...
//            Toast.makeText(this, "MyAlarmService.onCreate()", Toast.LENGTH_LONG).show();
            ...
            intentForNotification.putExtra(CityzenContracts.LATITUDE, latitude);
            intentForNotification.putExtra(CityzenContracts.LONGITUDE, longitude);
